...
- 总部**警觉**并批准毁灭性武力，**主要**靠伊莱带出的**军用级已投产/正在投产**情报（兼借势 [ENT-AIBACKLASH](../../../../设定真值/10-百科/文化/ENT-AIBACKLASH-人工智能污名化与第九区事变后的舆论分化.md)）。
...
| **新增**    | 第 17 年末–第 18 年初        | **军用级无人器械**在此窗口**才开始投产**（与民用改装线衔接，属前任管理员与伊莱布局一环）。前任管理员 **桥专属人类顾问** **伊莱·索伦** 按布局**假叛逃**；向军部/总部提供 **无人器械已部署、军用级已投产/正在投产** 情报，使军部**警觉**并打破「仅民用、可观望」的判断（借势社会对 AI 的恐惧，见 [ENT-AIBACKLASH](../../../../设定真值/10-百科/文化/ENT-AIBACKLASH-人工智能污名化与第九区事变后的舆论分化.md)）。**上交损毁母带**；私藏另一容器内**完整前任管理员副本**（公司不知，深层）。                                                                                                                                                                                               | 深层    | P3 |
...
在保留「前任管理员掌握无人产线/智能机器人工厂」总述前提下，**分列**（设定事实，禁止对玩家直述全貌）。**无人器械上的低级智能体容器**属于 **② 的对外延伸**，**不是**与①②并列的第三条线。
...
- **定义**：B-9002在常规叙事中**通常可拼到的上限**；与「投放」列（设定事实分层）对照见 [06](../四科科长人设/06-玩家情报层级与投放矩阵.md) 第六条。  
